...
class FrontEnd(object):
    ...
    def run(self):
        ...
        while not should_stop:
            ...
            cv2.putText(frame, text, (5, 680),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            
            pad_id = self.tello.get_mission_pad_id()  # retorna inteiro
            cv2.putText(frame, f"Pad ID: {pad_id}", (5, 710), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
            ...
            if pad_id == 8:  # inteiro
                ...
                try:
                    self.send_rc_control = False
                    self.tello.go_xyz_speed_mid(0, 0, 30, 30, pad_id)
                    self.tello.go_xyz_speed_mid(0, 0, 20, 10, pad_id)
                    self.tello.go_xyz_speed_mid(0, 0, 10, 10, pad_id)
